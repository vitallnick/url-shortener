...
# if launch in CLI: python app.py
# install python-dotenv package,
# create a .flaskenv file in your project root folder and
# add, for example, this:
# FLASK_APP=app.py (or whatever you named it)
# FLASK_ENV=development (or production)
# or type in CLI: export FLASK_APP=app.py
#            and: export FLASK_ENV=development
# in Windows replace 'export' to 'set'
